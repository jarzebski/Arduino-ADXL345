...
void draw() 
{
  ...
  drawChart("Pitch (Normal vs Filtered)", compareSeries, pitchValues, 10, 10, 200, -90, 90, 30);
  drawChart("Roll  (Normal vs Filtered)", compareSeries, rollValues, 10, 280, 200, -90, 90, 30);
